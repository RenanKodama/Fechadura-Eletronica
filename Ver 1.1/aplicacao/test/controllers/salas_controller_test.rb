...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { nomesala: @sala.nomesala, numerosala: @sala.numerosala } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { nomesala: @sala.nomesala, numerosala: @sala.numerosala } }
