...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { horarioentrada: @reserva.horarioentrada, horariosaida: @reserva.horariosaida, idreserva: @reserva.idreserva, motivo: @reserva.motivo } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { horarioentrada: @reserva.horarioentrada, horariosaida: @reserva.horariosaida, idreserva: @reserva.idreserva, motivo: @reserva.motivo } }
