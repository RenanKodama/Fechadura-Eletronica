class SalasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sala.save
        format.html { redirect_to @sala, notice: 'Sala Criada com sucesso.' }
  ...
  def destroy
    @sala.destroy
    respond_to do |format|
      format.html { redirect_to salas_url, notice: 'Sala foi Destruída com sucesso.' }
  ...
  private
    ...
    def sala_params
      params.require(:sala).permit(:numero, :descricao)
    end
end
