...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { horariofim: @reserva.horariofim, horarioinicio: @reserva.horarioinicio, motivo: @reserva.motivo } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { horariofim: @reserva.horariofim, horarioinicio: @reserva.horarioinicio, motivo: @reserva.motivo } }
